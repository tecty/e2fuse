...
static void op_ll_lookup(fuse_req_t req, fuse_ino_t parent, const char *name)
{
...
static void op_ll_read(fuse_req_t req, fuse_ino_t ino, size_t size, off_t off,
					   struct fuse_file_info *fi)
{
	(void)fi;
...
int main(int argc, char *argv[])
{
	...
	se = fuse_session_new(&args, &op_ll_oper, sizeof(op_ll_oper), NULL);
